## auv_msgs (noetic) - 0.1.1-1

The packages in the `auv_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --track noetic --rosdistro noetic auv_msgs --edit` on `Tue, 07 Jul 2020 06:44:05 -0000`
...
## auv_msgs (melodic) - 0.1.1-1

The packages in the `auv_msgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --track melodic --rosdistro melodic auv_msgs --edit` on `Tue, 07 Jul 2020 06:32:54 -0000`
...
## auv_msgs (kinetic) - 0.1.1-1

The packages in the `auv_msgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --rosdistro kinetic auv_msgs --edit` on `Tue, 07 Jul 2020 06:10:21 -0000`
